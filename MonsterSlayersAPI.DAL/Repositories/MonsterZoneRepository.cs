...
{
    public class MonsterZoneRepository : BaseRepository<MonsterZone>, IMonsterZoneRepository
    {
        public MonsterZoneRepository(MonsterSlayersContext context, string source = "") : base(context, source) { }
    }
}
