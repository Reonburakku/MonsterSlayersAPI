...
{
    public class MonsterSkillRepository : BaseRepository<MonsterSkill>, IMonsterSkillRepository
    {
        public MonsterSkillRepository(MonsterSlayersContext context) : base(context) { }
    }
}
